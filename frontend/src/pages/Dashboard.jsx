...
import { optimizeProcess, getHistory, getHealth } from "../services/api";
import translations from "../translations";

const MATERIALS = [
  { name:"Newspapers",        category:"Paper",   waste_type:"Organic", toxicity:"Low",    defaultWeight:"3",  defaultMoisture:"Dry" },
  { name:"Cardboard Boxes",   category:"Paper",   waste_type:"Organic", toxicity:"Low",    defaultWeight:"5",  defaultMoisture:"Dry" },
  { name:"Office Paper",      category:"Paper",   waste_type:"Organic", toxicity:"Low",    defaultWeight:"2",  defaultMoisture:"Dry" },
  ...
  { name:"Old Clothes",       category:"Textile", waste_type:"Organic", toxicity:"Low",    defaultWeight:"3",  defaultMoisture:"Dry" },
  { name:"Fabric Scraps",     category:"Textile", waste_type:"Organic", toxicity:"Low",    defaultWeight:"2",  defaultMoisture:"Dry" },
  { name:"Old Tires",         category:"Rubber",  waste_type:"Rubber",  toxicity:"Medium", defaultWeight:"15", defaultMoisture:"Dry" },
  { name:"Rubber Footwear",   category:"Rubber",  waste_type:"Rubber",  toxicity:"Low",    defaultWeight:"3",  defaultMoisture:"Dry" },
  { name:"Wooden Pallets",    category:"Wood",    waste_type:"Organic", toxicity:"Low",    defaultWeight:"20", defaultMoisture:"Dry" },
  { name:"Furniture Scraps",  category:"Wood",    waste_type:"Organic", toxicity:"Low",    defaultWeight:"10", defaultMoisture:"Dry" },
];

const CAT_ICONS  = { Paper:"📄", Plastic:"🧴", Glass:"🫙", Textile:"👕", Rubber:"🛞", Wood:"🪵" };
const CAT_COLORS = {
  Paper:   { main:"#2E7D32", light:"#E8F5E9", bar:"#66BB6A" },
  Plastic: { main:"#E65100", light:"#FFF3E0", bar:"#FF7043" },
  Glass:   { main:"#00695C", light:"#E0F2F1", bar:"#26A69A" },
  Textile: { main:"#6A1B9A", light:"#F3E5F5", bar:"#AB47BC" },
  Rubber:  { main:"#37474F", light:"#ECEFF1", bar:"#78909C" },
  Wood:    { main:"#4E342E", light:"#EFEBE9", bar:"#8D6E63" },
};
const SAFETY_META = {
  CRITICAL:{ color:"#C62828", light:"#FFEBEE", border:"#EF9A9A", icon:"🚨", label:"Critical Risk" },
  WARNING: { color:"#E65100", light:"#FFF3E0", border:"#FFCC80", icon:"⚠️", label:"Warning"       },
  SECURE:  { color:"#1B5E20", light:"#E8F5E9", border:"#A5D6A7", icon:"✅", label:"Secure"        },
};
const METHOD_META = {
  Mechanical:{ icon:"⚙️", color:"#2E7D32", light:"#E8F5E9", desc:"Shred & Crush"    },
  Thermal:   { icon:"🔥", color:"#BF360C", light:"#FBE9E7", desc:"Melt & Pyrolysis"  },
...
// Green theme
const G  = "#1B5E20";   // dark green
const GL = "#2E7D32";   // medium green
const GLL= "#43A047";   // light green
const GB = "#E8F5E9";   // green bg
...
export default function Dashboard() {
  ...
  const [selectedMaterial,setSelectedMaterial] = useState(MATERIALS[3]);
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        body{background:#F4F6F4;font-family:'Times New Roman',Georgia,serif;color:#1A1A1A;}
        ::-webkit-scrollbar{width:5px;} ::-webkit-scrollbar-track{background:#F0F0F0;} ::-webkit-scrollbar-thumb{background:#A5D6A7;border-radius:3px;}
          ...
          <div style={{padding:"28px 32px",flex:1}}>
            ...
            {activeTab==="home"&&(
              <div className="fade-up">
                ...
                <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:16,marginBottom:24}}>
                  {[
                    {val:"14",sub:t.statSubMat,  label:t.statMaterials, icon:"📦",col:GL, bg:GB},
                    ...
                    {val:"7K",sub:t.statSubRows, label:t.statRows,      icon:"📊",col:"#E65100",bg:"#FFF3E0"},
                  ].map(s=>(
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20,marginBottom:24}}>
                  ...
                  <div className="card" style={{background:"#FFFFFF",borderRadius:10,border:"1px solid #E8E8E8",padding:"22px",boxShadow:"0 1px 4px rgba(0,0,0,0.05)"}}>
                    ...
                    <div style={{display:"flex",justifyContent:"center",gap:32,alignItems:"center"}}>
                      <Donut pct={64} color={GL} label="Mechanical (9)" size={110}/>
                      <Donut pct={36} color="#BF360C" label="Thermal (5)" size={110}/>
                    </div>
                  </div>
                </div>
                ...
                <div className="card" style={{background:"#FFFFFF",borderRadius:10,border:"1px solid #E8E8E8",padding:"22px",boxShadow:"0 1px 4px rgba(0,0,0,0.05)"}}>
                  ...
                  {MATERIALS.map((m,i)=>{
                    const method=["Plastic","Rubber"].includes(m.category)?"Thermal":"Mechanical";
              ...
              <div className="fade-up" style={{display:"grid",gridTemplateColumns:"280px 1fr",gap:24}}>
                ...
                <div style={{display:"flex",flexDirection:"column",gap:20}}>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16}}>
                    ...
                    <div className="card" style={{background:"#FFFFFF",borderRadius:10,border:"1px solid #E0E0E0",padding:"20px 22px",boxShadow:"0 1px 4px rgba(0,0,0,0.05)"}}>
                      <div style={{fontSize:10,fontWeight:700,color:GL,letterSpacing:"0.12em",fontFamily:F,marginBottom:14}}>{t.labelMoisture}</div>
                  ...
                  <div className="card" style={{background:"#FFFFFF",borderRadius:10,border:"1px solid #E0E0E0",padding:"20px 22px",boxShadow:"0 1px 4px rgba(0,0,0,0.05)"}}>
                    ...
                    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
                      {[
                        {val:"Organic", icon:"🌿", desc:"Paper · Textile · Wood"},
                        {val:"Plastic", icon:"🧴", desc:"PET · Containers · Bags"},
                        {val:"Glass",   icon:"🫙", desc:"Bottles · Jars"},
                        {val:"Rubber",  icon:"🛞", desc:"Tires · Footwear"},
                      ].map(wt=>(
            ...
            {activeTab==="result"&&result&&(()=>{
              ...
              const radarData=[
                ...
                {label:"Energy",     value:Math.min(result.energy_kwh/20,1)},
                {label:"Time",       value:Math.min(result.processing_time_min/60,1)},
                ...
                <div className="fade-up" style={{display:"flex",flexDirection:"column",gap:20}}>
                  ...
                  <div style={{display:"flex",gap:10,flexWrap:"wrap",padding:"12px 18px",background:"#FFFFFF",borderRadius:8,border:"1px solid #E0E0E0",alignItems:"center"}}>
                    ...
                    {[
                      ...
                      {val:moisture==="Wet"?"💧 Wet":"☀️ Dry",col:moisture==="Wet"?G:"#E65100",bg:moisture==="Wet"?GB:"#FFF3E0",border:moisture==="Wet"?GLL+"40":"#FFCC80"},
                    ...
                    <div style={{display:"flex",flexDirection:"column",gap:14}}>
                      ...
                      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
                        <div style={{background:"#FFFFFF",borderRadius:10,border:"1px solid #E0E0E0",padding:"14px 16px",display:"flex",alignItems:"center",gap:10}}>
                          ...
                          <div><div style={{fontSize:10,color:"#9E9E9E",fontFamily:F}}>{t.totalEnergy}</div><div style={{fontSize:18,fontWeight:700,color:"#E65100",fontFamily:F}}>{result.energy_kwh} kWh</div></div>
                        </div>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:16}}>
                    ...
                    <div className="card" style={{background:"#FFFFFF",borderRadius:10,border:"1px solid #E0E0E0",padding:"20px",boxShadow:"0 1px 4px rgba(0,0,0,0.05)"}}>
                      ...
                      <HBar value={result.energy_kwh} max={20} color="#E65100" label={t.energyConsump} unit=" kWh" delay={150}/>
                      <HBar value={result.processing_time_min} max={120} color={GL} label={t.processingTime} unit=" min" delay={300}/>
                    ...
                    <div className="card" style={{background:"#FFFFFF",borderRadius:10,border:"1px solid #E0E0E0",padding:"20px",boxShadow:"0 1px 4px rgba(0,0,0,0.05)"}}>
                      ...
                      <div style={{display:"flex",justifyContent:"space-around",flexWrap:"wrap",gap:8}}>
                        ...
                        <Donut pct={Math.min((result.energy_kwh/20)*100,100)} color="#E65100" label={t.energyLoad} size={90}/>
